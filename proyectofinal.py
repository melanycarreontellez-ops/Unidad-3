...
# -------------------------
# ESTILO DE BOTONES (VERDE MENTA)
# -------------------------
estilo = ttk.Style()

# Forzamos un tema que permita color en botones
estilo.theme_use("clam")

# Configuramos el estilo Mint.TButton
estilo.configure(
    "Mint.TButton",
    font=("Arial", 12),
    padding=10,
    background="#3ED6A6",      # Verde menta
    foreground="white",
    bordercolor="#3ED6A6",
    focusthickness=3,
    focuscolor="none"
